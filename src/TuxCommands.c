...
LIBEXPORT void Tux_Open(char *motor)
{
...
LIBEXPORT void Tux_OpenClose(char *motor, int count)
{
	if(!strcmp(strtolower(motor),"eyes"))
...
LIBEXPORT void Tux_Leds_OnOff(char *led, char *action)
{
...
LIBEXPORT void Tux_Leds_Blink(char *led, char *count, char *delay)
{
...
LIBEXPORT void Tux_Leds_Pulse(char *led, char *min_intensity, char *max_intensity, char *count, char *period, char *effect, char *speed, char *step)
{
	leds_t LED = getLedsFromString(led);
...
LIBEXPORT void Tux_Micro(char *action, char *file)
{
...
LIBEXPORT void Tux_Rotate(char *action, char *count)
{
	if(!atoi(count))
		return;
...
LIBEXPORT void Tux_Flash(char *sound, char *amplitude)
{
...
LIBEXPORT void Tux_Audio(char *action, char *rawcmd)
{
...
LIBEXPORT void Tux_Wakeup(void)
{
	char cmd[32];
...
LIBEXPORT void Tux_Off(char *motor)
{
...
LIBEXPORT void Tux_TTS(char **argv, int argc)
{
