...
extern void Tux_Open(char *motor);
extern void Tux_Close(char *motor);
extern void Tux_OpenClose(char *motor, int count);
extern void Tux_Leds_OnOff(char *led, char *action);
extern void Tux_Leds_Blink(char *led, char *count, char *delay);
extern void Tux_Leds_Pulse(char *led, char *min_intensity, char *max_intensity, char *count, char *period, char *effect, char *speed, char *step);
extern void Tux_Micro(char *action, char *file);
extern void Tux_Flippers(char *action, char *count);
extern void Tux_Rotate(char *action, char *count);
...
extern void Tux_Off(char *motor);
extern void Tux_Reset(void);
void Tux_Timestamp(tux_client  client);

extern void Tux_TTS(char **argv, int argc);
